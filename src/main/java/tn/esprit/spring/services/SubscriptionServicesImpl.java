...
public class SubscriptionServicesImpl implements ISubscriptionServices{
   ...
   @Scheduled(cron = "0 0 9 1 * ?") // Expression Cron pour exécuter mensuellement à 9h
   public void showMonthlyRecurringRevenue() {
       ...
       if (monthlyRevenue != null && semiAnnualRevenue != null && annualRevenue != null) {
           Float revenue = monthlyRevenue + semiAnnualRevenue / 6 + annualRevenue / 12;
           log.info("Revenu mensuel = " + revenue);
       } else {
           log.warn("Certaines valeurs de revenu sont nulles.");
       }
   }
